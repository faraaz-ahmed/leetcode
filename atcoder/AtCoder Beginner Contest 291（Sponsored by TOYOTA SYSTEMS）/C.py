...
The
N moves are represented by a string of length
...
S
Output
Print Yes if Takahashi visited the same coordinates multiple times in the course of the
N moves; print No otherwise.
